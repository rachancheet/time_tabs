...
export default function loda(){
    ...
    if(router.isReady && typeof cookie.name !="undefined" &&cookie.name==" "){
        router.push("/login")  
      }
    ...
    <form onSubmit={handlesubmit}>      
            ...
            </h1>
          {
            ...
            <div className='flex flex-col'> 
                      ...
                      {timings[index2]}: <input onChange={(e)=>{
                        let copy = fact;
              ...
              <button className='bg-lime-400 text-black bg-repeat-round'>submit</button>
    </form>
</div>
